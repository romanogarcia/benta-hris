INSERT INTO `countries` (`country_code`, `country_name`, `currency_code`, `fips_code`, `iso_numeric`, `north`, `south`, `east`, `west`, `capital`, `continent_name`, `continent`, `languages`, `iso_alpha_3`, `geo_name_id`) VALUES
