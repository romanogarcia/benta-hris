      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <!-- <form action="/employees/searchnow" method="post">
			...
			@endif
			@if((check_permission(Auth::user()->Employee->department_id,"Employees","full")) || (check_permission(Auth::user()->Employee->department_id,"Employees","View")))
        ...
        $('#laravel_datatable').DataTable({
            ...
            ajax: {
                ...
                data: function (f) {
                    ...
                    f.postbtn = postbtn;
                    f.from_emp_list = <?php  echo ($from_emp_list)?1:0; ?>;
                }
            },	  
            columns: [
