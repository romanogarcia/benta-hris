      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <a style="position: relative; z-index: 999;" href="{{ URL('roles/create' ) }}" class="btn btn-primary btn-icon-text btn-sm">
              <i class="mdi mdi-account-plus"></i> Add New User Role
            </a>
          </div>
          ...
          <div id="search_form_container">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="form-group">
                    <input class="form-control form-control-sm" type="text" placeholder="Role Name" name="role_name" id="role_name">
                </div>
              </div>
                <!-- <div class="form-group">
