...
@section('title', 'Attendances Report')
@section('content')
...
<div class="content-wrapper">
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row" id="history-search-form">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div class="form-group">
							<input type="text" data-date="" data-date-format="DD MMMM YYYY" value="" class="form-control form-control-sm is_datefield" name="last_updated" id="last_updated" readonly="readonly" placeholder="Last Updated" style="background: rgb(255, 255, 255);" data-placeholder="available">
						</div>
					</div>
        ...
        ajax: {
            ...
            data: function (f) {
				...
				f.time_in = $('#time_in').val();
		  		...
		  		f.last_updated = $("#last_updated").val();
            }
        },	  
        columns: [
