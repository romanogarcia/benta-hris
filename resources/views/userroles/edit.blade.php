    ...
    <div class="content">
        <div class="container-fluid p-5">
            ...
            <div class="card col-lg-12 col-xs-12 col-md-12">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action='{{ url("dashboard/userroles/update/$record->id") }}'
						...
						<div class='row'>
							<div class="col-md-6 col-lg-6 col-xs-12">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('type') is-invalid @enderror" id="type" name="type"  value="{{ $record->type }}" placeholder="Role Type">
									@error('type')
