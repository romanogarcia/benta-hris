<html>
    <head>
        <title>Print Custom Barcode</title>
        <meta charset="utf-8">
...
<div class="no-print btn-print-container">
    <button onclick="window.print();" type="button" title="Click to Print" class="btn-primary btn-sm">PRINT</button>
</div> 

@if($layout_type == 'default')
    <div class="paper-page paper-page-default">
       <img class="barcode" src="data:image/png;base64,{!!DNS1D::getBarcodePNG($property_numbers[0], 'C128')!!}" alt="Barcode" height="38" width="180">
