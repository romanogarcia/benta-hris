...
@section('title', 'Print Custom Barcode')
@section('customcss')
  <style> </style>
@endsection
      ...
      $(document).ready(function (){
         ...
         $("#print-preview_container").on('click', '.btn-print_', function (){
            ...
            if(!validate){
               ...
               $(".required-alert").hide();
               var window_url = '{{route("asset_print_custom_barcode.print_preview_custom_barcode", ["data_array"=>"", "layout_type"=>""])}}'+'/'+data_array+'/'+layout_type;
