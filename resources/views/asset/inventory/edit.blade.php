               ...
               <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control is_datefield @error('date_acquired') is-invalid @enderror is_datefield" name="date_acquired" id="date_acquired" placeholder="Date Acquired"  value="{{$data->date_acquired}}">
                          @error('date_acquired')
                             <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                             </span>
                                    ...
                                    <div class="input-group">
                                       <select class="form-control @error('supplier') is-invalid @enderror" name="supplier" id="supplier" >
                                          ...
                                          @foreach($suppliers as $supplier)
                                             ...
                                             <option @if($supplier->id == old('supplier')|| $supplier->id == $data->supplier_id) selected @endif value="{{$supplier->id}}">{{ucfirst($supplier->first_name)." ".ucfirst($supplier->last_name)}}</option>
                                             @else
                                       ...
                                       <div class="input-group">
                                          <select class="form-control @error('location') is-invalid @enderror" name="location" id="location" >
                                             ...
                                             @foreach($locations as $location)
                                                <option @if($location->id == old('location')|| $location->id == $data->location_id) selected @endif value="{{$location->id}}">
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control @error('notes') is-invalid @enderror" name="notes" id="notes" placeholder="Notes"  value="{{$data->notes}}">
                                                   @error('notes')
                                                      <span class="invalid-feedback" role="alert">
                                                         <strong>{{ $message }}</strong>
                                                      </span>
